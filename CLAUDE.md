...
- **Pin third-party actions to a commit SHA** with a trailing version comment
  (e.g. `reviewdog/action-shellcheck@4c07...86e  # v1`). First-party
  `actions/*` and `ruby/setup-ruby` are pinned to a tag.
